    ...
    <div class="container_gateaux">
        <div class="list_content">
          ...
          <ul class="list_item">
            ...
            <li><a href="">Bánh Sinh Nhật 2023</a></li>
            <li><a href="">Bánh Mousse</a></li>
            <li><a href="">Gateaux Mousse</a></li>
            <li><a href="">GATEAUX MOUSSE YOGURT</a></li>
...
?> 
        <div class="button_gateaux">
          <a class="button-1" href="list_gateaux.php">
            <button>
                <<
            </button></a>
          <a class="button-2" href="list_gateaux.php">
            <button>
              1
            </button></a>
