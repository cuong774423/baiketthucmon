...
<?php
   ...
   $sql = "SELECT * FROM banhgateaux WHERE malbanhsn='$malbanhsn' LIMIT $limit";
   $kq = mysqli_query($cn, $sql) or die('truy vấn sai!');
   while ($row = mysqli_fetch_assoc($kq)) { 
?>
      <div class="bsn1">
         <a href="chitietbanh.php?a=<?php echo $row['mabanhsn'] ?>">
            <img src="image/<?php echo $row['anhbanhsn']; ?>">
         </a>
         <a class="name-bsn" href="chitietbanh.php?a=<?php echo $row['mabanhsn']; ?>"><?php echo $row['tenloaibanhsn']; ?></a>
         <span><?php echo $row['mabanhsn']; ?></span>
         <div class="price1">
            <span class="price-cart"><?php echo $row['gia']*1000; ?></span><sup>đ</sup>
            <span class="add-cart">
...
?>
   ...
   <div class="viewmore1">
   <a href='list_gateaux.php'>
      <span>XEM THÊM</span></a>
    </div>
    </div>
<div class="gateaux-collection">
<h1>GATEAUX KEM TUƠI</h1>
<i class="fa-solid fa-cake-candles"></i>
<div class="bsn-img">
<?php 
   $limit = 12;
   ...
   $sql21 = "SELECT * FROM banhgateaux  WHERE malbanhsn='$malbanhsn' LIMIT $limit";
...
?>
      <div class="bsn1">
         ...
         <a class="name-bsn" href='chitietbanh.php?a=<?php $row21['mabanhsn'] ?>'><?php echo $row21['tenloaibanhsn']; ?></a>
...
<div class="container-order">
  <div class="order-online">
    ...
    <h1>ĐẶT HÀNG ONLINE NGAY!</h1>
    <h2>KHÔNG CÒN PHẢI CHỜ ĐỢI NƯA</h2>
    </div>
...
<div class="about-us">
  <div class="title-about">
    <h1>VỀ CHÚNG TÔI</h1>
    <span>CHÀO MỪNG BẠN ĐẾN VỚI ANH HÒA BAKERY</span>
  </div>
  <div class="about-img">
    <img src="image/intro.png" alt="">
    <div>
    <p>Anh Hòa Bakery là thương hiệu bánh ngọt Pháp của công ty cổ phần bánh ngọt Anh Hòa. Được thành lập từ năm 2004 tại con phố Ngõ Trạm, quận Hoàn Kiếm, Hà Nội. Trải qua hơn 15 năm phát triển, đến nay Anh Hòa Bakery đã có 13 cơ sở kinh doanh đặt trên những tuyến phố đông dân cư ở Hà Nội. Các sản phẩm Anh Hòa Bakery được làm từ các nguyên liệu nhập khẩu của các nước có truyền thống làm bánh như: Newzeland, Mỹ, Pháp, Bỉ. Với hương vị thơm ngon đặc trưng của các loại kem, bơ, sữa, phô mai, hạt hạnh nhân, chocolate... dưới bàn tay khéo léo của những người thợ làm bánh giàu kinh nghiệm. Quy mô xưởng sản xuất rộng hơn 2000m2 với các thiết bị tiên tiến hiện đại theo tiêu chuẩn ISO 2018, toàn bộ nhà máy được sơn phủ bởi sơn EPOXY đặc biệt. Anh Hòa Bakery luôn mang đến cho khách hàng những sản phẩm chất lượng nhất, đảm bảo tuyệt đối về an toàn vệ sinh thực phẩm. </p>
    <span>ĐỌC THÊM</span>
    </div>
  </div>
</div>
